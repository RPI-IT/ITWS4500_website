...
### 2. GitHub Repository Setup (Not Graded)

Your repository should be initialized with the following structure. While not graded as part of the proposal, this setup will be expected for later project milestones:
