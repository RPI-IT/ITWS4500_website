...
format:
  revealjs:
    ...
    footer: "ITWS-4500 | Week 2, Day 1 | Lab 1"
    slide-number: true
    transition: slide
    width: 1600
    height: 900
...
# Lab 1 Overview {.section-slide background-color="#d6001c"}
...
Complete the following by **Thursday, January 23**:
...
# Getting Started with GitHub Classroom {.section-slide background-color="#d6001c"}

## Accept the Assignment

### Step 1: Click the GitHub Classroom Link

[https://classroom.github.com/a/Gbc2JCRP](https://classroom.github.com/a/Gbc2JCRP)
...
# Git Commit Workflow {.section-slide background-color="#d6001c"}
...
- [ ] `docker compose up --build` works in your repository
- [ ] README.md includes setup instructions
- [ ] No secrets committed (check `.gitignore`)
- [ ] Fill out the `answers.yml` file
