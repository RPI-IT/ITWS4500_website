...
|------|---------------------|
| `domain/entities/Task.js` | `isHighPriority()`, `complete()`, `validate()` |
| `domain/services/TaskDomainService.js` | `canTransitionStatus()`, `calculatePriorityScore()`, `getHighPriorityTasks()` |
